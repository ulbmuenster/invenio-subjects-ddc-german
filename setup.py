...
g = {}
with open(os.path.join('invenio_subjects_ddc_german', 'version.py'), 'rt') as fp:
    exec(fp.read(), g)
...
setup(
    ...
    url='https://github.com/ulbmuenster/invenio-subjects-ddc-german',
    packages=packages,
    zip_safe=False,
    ...
    entry_points={
        ...
        'invenio_rdm_records.fixtures': [
            'invenio_subjects_ddc_german = invenio_subjects_ddc_german.vocabularies',
        ],
    },
